...
export class AccountOrdersComponent implements OnInit, OnDestroy {
  ...
  nextProcess(idOrder, index) {
    ...
    //Esconder la edicion de entrega del producto cuando este aún no ha sido enviado
  ...
  onSubmitProcess(){
    ...
    console.log(this.editNextProcess);
    console.log(this.newNextProcess);
