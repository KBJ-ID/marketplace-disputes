    ...
    resetPassword(value){
		...
		this.usersService.getFilterData("email", value).subscribe(resp=>{
			...
			if(Object.keys(resp).length > 0){
				...
				Sweetalert.fnc("error", "The email does not exist", null)
			}
		})
    ...
    newPassword(value){
  	...
  	facebookLogin(){
		...
		const firebaseConfig = {
			apiKey: "AIzaSyAFdZCnL387NoHO_xmpFC3eTRRZaZZTp50",
			authDomain: "marketplace-3951a.firebaseapp.com",
			databaseURL: "https://marketplace-3951a.firebaseio.com",
			projectId: "marketplace-3951a",
			storageBucket: "marketplace-3951a.appspot.com",
			messagingSenderId: "543589412111",
			appId: "1:543589412111:web:453079648d244e8face27a"
		}
