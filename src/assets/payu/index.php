...
if (isset($_POST["response_code_pol"]) && $_POST["response_code_pol"] == 1) {
    ...
    if (isset($_POST["extra1"])) {
        ...
        foreach ($idProducts as $key => $value) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://marketplace-3951a.firebaseio.com/products/" . explode(",", $value)[0] . ".json",
    ...
    if (isset($_POST["extra2"])) {
        ...
        foreach ($idOrders as $key => $value) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://marketplace-3951a.firebaseio.com/orders/" . $value . ".json",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => "",
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
    ...
    if (isset($_POST["extra3"])) {
        ...
        foreach ($idSales as $key => $value) {
            ...
            curl_setopt_array($curl, array(
                CURLOPT_URL => "https://marketplace-3951a.firebaseio.com/sales/" . $value . ".json",
                CURLOPT_RETURNTRANSFER => true,
                CURLOPT_ENCODING => "",
                CURLOPT_MAXREDIRS => 10,
                CURLOPT_TIMEOUT => 0,
